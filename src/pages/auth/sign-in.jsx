...
export function SignIn() {
  ...
  const handleSignIn = (e) => {
    ...
    // Check if the email and password match the temporary ID
    if (email === "tom@creativetim.com" && password === "Horses_are_running") {
      // Navigate to the dashboard/home after successful sign-in
  ...
  return (
    <section className="m-8 flex gap-4">
      ...
      <div className="w-2/5 h-full hidden lg:block">
        <img
          src="/horses-website-deployed/img/pattern.png"
