const countryFlagURL = (countryCode) => {
        ...
        <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
          <table className="w-full min-w-[640px] table-auto">
            <thead>
              <tr>
                {[
                  "Horse", "Country", "Runners", "Runs", "Winners", "Wins", "WinPercent_", "Stakes_Winners", "Stakes_Wins",
  ...
  export function HorseProfiles() {
    ...
    const [selectedTable, setSelectedTable] = useState("horse_profile");
    ...
    return (
      <div className="mt-12 mb-8 flex flex-col gap-12">
        <div className="flex items-center mb-2">
          ...
          >
            <option value="horse_profile">Overall</option>
            <option value="horse_profile">Last 03 Years</option>
            <option value="horse_profile">Last 01 Year</option>
          </select>
        </div>
