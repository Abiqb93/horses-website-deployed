      ...
      <table className="w-full h-full table-auto text-xs border-collapse border border-gray-200"> {/* Adjusted width & height */}
        <thead>
          <tr>
            ...
            <th className="border border-gray-300 py-1 px-2 text-left">{entry2 ? entry2.Sire : "Entry 2 (Select a trainer)"}</th>
          </tr>
        </thead>
        <tbody>
  ...
  return (
    <div className="mt-4 mb-0 flex flex-col gap-5">
      ...
      <div className="flex items-center gap-4">
        <label htmlFor="trainer-selector" className="text-sm font-medium">
          Select Entry:
        </label>
        <select
          id="trainer-selector"
