...
} from "@/data"; // Import only Trainer tables
...
const RadarChart = ({ entry1Data, entry2Data }) => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: entry1Data ? entry1Data.trainer_name : "Entry 1",
        data: [
      ...
      {
        label: entry2Data ? entry2Data.trainer_name : "Entry 2",
        data: [
...
export function TrainerProfiles() {
  ...
  const title = "Trainer Report Table";
  const firstColumn = "trainer_name";
