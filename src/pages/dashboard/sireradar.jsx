...
export function SireRadar() {
  ...
  const fetchFilteredData = async (searchQuery, setTableData) => {
      try {
        ...
        const response = await fetch(
          `https://horseracesbackend-production.up.railway.app/api/sire_profile?${params.toString()}`
        );
  ...
  return (
    <div className="mt-4 mb-0 flex flex-col gap-5">
      ...
      {/* <HorseProfile setSearchQuery={setSearchQuery1} placeholder="Search Sire 1..." />
      <HorseProfile setSearchQuery={setSearchQuery2} placeholder="Search Sire 2..." />
      <ReportTable tableData={tableData1} title="Sire 1 Table" onSelectRow={handleSelectRow1} />
      <ReportTable tableData={tableData2} title="Sire 2 Table" onSelectRow={handleSelectRow2} /> */}

      <div className="flex justify-between gap-4">
        <div className="w-1/2">
          <HorseProfile setSearchQuery={setSearchQuery1} placeholder="Search Sire 1..." className="mb-4"  />
          <ReportTable tableData={tableData1} title="Sire 1 Table" onSelectRow={setSelectedEntry1} />
        </div>

        <div className="w-1/2">
          <HorseProfile setSearchQuery={setSearchQuery2} placeholder="Search Sire 2..." className="mb-4"  />
          <ReportTable tableData={tableData2} title="Sire 2 Table" onSelectRow={setSelectedEntry2} />
        </div>
      </div>
