      ...
      <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
        <table className="w-full min-w-[640px] table-auto">
          <thead>
            <tr>
              {[
                "Jockey", "Country", "Runners", "Runs", "Winners", "Wins", "WinPercent_", "Stakes_Winners", "Stakes_Wins",
...
export function JockeyProfiles() {
    ...
    <div className="mt-12 mb-8 flex flex-col gap-12">
      <div className="flex items-center mb-2">
        ...
        >
          ...
          <option value="jockey_name_profile_three">Last 03 Years</option>
          <option value="jockey_name_profile_one">Last 01 Year</option>
        </select>
      </div>
