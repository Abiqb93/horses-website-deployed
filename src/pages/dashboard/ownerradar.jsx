    ...
    <Card className="bg-white text-black">
      ...
      <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
        <table className="w-full min-w-[640px] table-auto">
          <thead>
            <tr>
              {["Owner", "Runners", "Runs", "Winners", "Wins", "WinPercent_", "Stakes_Winners", "Stakes_Wins", "Group_Winners", "Group_Wins", "RB2"].map((el) => (
...
export function OwnerRadar() {
  ...
  const fetchFilteredData = async (searchQuery, setTableData) => {
      try {
        ...
        const response = await fetch(
          `https://horseracesbackend-production.up.railway.app/api/owner_profile?${params.toString()}`
        );
  ...
  return (
    <div className="mt-4 mb-0 flex flex-col gap-5">
      ...
      {/* <HorseProfile setSearchQuery={setSearchQuery1} placeholder="Search Owner 1..." />
      <HorseProfile setSearchQuery={setSearchQuery2} placeholder="Search Owner 2..." />
      <ReportTable tableData={tableData1} title="Owner 1 Table" onSelectRow={handleSelectRow1} />
      <ReportTable tableData={tableData2} title="Owner 2 Table" onSelectRow={handleSelectRow2} /> */}

      <div className="flex justify-between gap-4">
        <div className="w-1/2">
          <HorseProfile setSearchQuery={setSearchQuery1} placeholder="Search Owner 1..." className="mb-4"  />
          <ReportTable tableData={tableData1} title="Owner 1 Table" onSelectRow={setSelectedEntry1} />
        </div>

        <div className="w-1/2">
          <HorseProfile setSearchQuery={setSearchQuery2} placeholder="Search Owner 2..." className="mb-4"  />
          <ReportTable tableData={tableData2} title="Owner 2 Table" onSelectRow={setSelectedEntry2} />
        </div>
      </div>
