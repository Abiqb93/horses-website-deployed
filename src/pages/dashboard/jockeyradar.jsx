...
} from "@/data"; // Import only Jockey tables
...
const RadarChart = ({ entry1Data, entry2Data }) => {
  ...
  const data = {
    ...
    datasets: [
      {
        label: entry1Data ? entry1Data.jockey_name : "Entry 1",
        data: [
      ...
      {
        label: entry2Data ? entry2Data.jockey_name : "Entry 2",
        data: [
...
export function JockeyProfiles() {
  ...
  const title = "Jockey Report Table";
  const firstColumn = "jockey_name";
